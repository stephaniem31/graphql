...
var getAuthor = function(args) {
    if(args.author) {
        ...
        return coursesData.filter(course => course.author.includes(author));
    } else {
        return coursesData
    }
}
...
var createCourse = function(arg) {
    coursesData.push(arg.course)
    return coursesData;
    };

/*var deleteCourse = function({id}) {
    const index = 
    coursesData.splice(0, 1)
    return coursesData;
}
*/
